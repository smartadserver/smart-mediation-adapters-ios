//
//  SASTapjoyInterstitialAdapter.h
//  SmartAdServer
//
...
/**
 Tapjoy interstitial adapter class for Smart SDK mediation.
 ...
 */
@interface SASTapjoyInterstitialAdapter : SASTapjoyBaseAdapter <SASMediationInterstitialAdapter, TJPlacementDelegate>
